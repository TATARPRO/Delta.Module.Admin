...
import { WidgetZone, WidgetFormBase } from '../../../../core/core-interface';
...
export class SearchWidgetComponent extends ComponentBase implements OnInit, AfterViewInit {
 
  public model: WidgetFormBase = new WidgetFormBase();
  public widgetZones: WidgetZone[] = new Array<WidgetZone>();
  public widgetFormGroup: WidgetFormGroup = new WidgetFormGroup();
  public title: string = "Search Mobile";
  public isEditMode = false;
  public isSubmitting = false;
  private apiRoutes = {
    read: "/projectv/search-mobile/read/",
    create: "/projectv/search-mobile/create/",
    update: "/projectv/search-mobile/update/"
  }
  public constructor(activatedRoute: ActivatedRoute, private router: Router,
    private coreEndpoints: EndpointMetadata) {
    super('search-widget')
    if (activatedRoute.snapshot.params["id"]) {
      this.isEditMode = true;
      this.model.id = activatedRoute.snapshot.params["id"]
    }
    this.updatePageTitle("Search Mobile: Delta Admin")
  }

...
import { ProductClassicPickedRoutingComponent, ProductClassicPickedRoutingModule } from './product-picked.routing';
...
@NgModule({
  declarations: [ProductClassicPickedRoutingComponent],
  imports: [ProductClassicPickedRoutingModule, CommonModule, FormsModule, ReactiveFormsModule,
    ProductSelectionModule, DeltaCommonsModule],
  providers: [CatalogEndpoints, CoreVEndpoints]
})
export class ProductClassicPickedModule {

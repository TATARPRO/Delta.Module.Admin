...
@Component({
  selector: 'container102-component',
  templateUrl: './container102.html'
})
export class Container102Component extends ComponentBase implements OnInit, AfterViewInit {
